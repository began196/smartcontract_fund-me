...
contract FundMeTest is Test {
    ...
    function testFundFailsWithoutEnoughEth() public {
        vm.expectRevert();
        // assert(this tx should fails)
        fundMe.fund(); // send no value which is less than minimum
    }
    ...
    function testWithdrawWithASingleFunder () public funded {
        ...
        assertEq(stratingFundMeBalance + startingOwnerBalance, endingOwnerBalance);

    }

    function testWithdrawFromMultipleFunders() public funded {
        // Need uint160 to work with address
